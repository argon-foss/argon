...
function Navbar() {
  ...
  return (
    <header className={`fixed top-0 ${sidebarVisible ? 'left-56' : 'left-0'} right-0 h-12 mt-1.5 ml-1 mr-2 rounded-lg bg-gray-200/30 backdrop-blur flex items-center z-50 justify-between transition-all duration-300 ease-in-out`}>
